...
public:
    ...
    QPushButton *pushButton_ProAdd;
    QPushButton *pushButton_ProDel;
    QLabel *label_5;
    QLineEdit *lineEdit_Score;
    QPushButton *pushButton_ProEdit;
    ...
    void setupUi(QDialog *practise)
    {
        ...
        pushButton_ProAdd = new QPushButton(practise);
        pushButton_ProAdd->setObjectName(QString::fromUtf8("pushButton_ProAdd"));
        pushButton_ProAdd->setGeometry(QRect(30, 540, 61, 51));
        pushButton_ProDel = new QPushButton(practise);
        pushButton_ProDel->setObjectName(QString::fromUtf8("pushButton_ProDel"));
        pushButton_ProDel->setEnabled(true);
        pushButton_ProDel->setGeometry(QRect(210, 540, 61, 51));
        ...
        pushButton_ProEdit = new QPushButton(practise);
        pushButton_ProEdit->setObjectName(QString::fromUtf8("pushButton_ProEdit"));
        pushButton_ProEdit->setEnabled(true);
        pushButton_ProEdit->setGeometry(QRect(120, 540, 61, 51));
    ...
    void retranslateUi(QDialog *practise)
    {
        ...
        pushButton_ProAdd->setText(QApplication::translate("practise", "\346\267\273\345\212\240\351\242\230\347\233\256", 0, QApplication::UnicodeUTF8));
        pushButton_ProDel->setText(QApplication::translate("practise", "\345\210\240\351\231\244\351\242\230\347\233\256", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("practise", "Score\357\274\232", 0, QApplication::UnicodeUTF8));
        pushButton_ProEdit->setText(QApplication::translate("practise", "\344\277\256\346\224\271\351\242\230\347\233\256", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
